  ...
  ([
                ...
                textDecoration.textDecorationLine.forEach(function (textDecorationLine) {
                  switch (textDecorationLine) {
                    case _textDecoration.TEXT_DECORATION_LINE.UNDERLINE:
                      ...
                      var baseline = _options$fontMetrics$.baseline
                    ...
                    case _textDecoration.TEXT_DECORATION_LINE.LINE_THROUGH:
                      ...
                      var middle = _options$fontMetrics$2.middle
      ...
      var renderElement = exports.renderElement = function renderElement (element, options, logger) {
        ...
        return (options.foreignObjectRendering // $FlowFixMe
          ...
          return supportForeignObject ? (function (cloner) {
            ...
            var container = _ref3[0]

            var clonedElement = _ref3[1]

            var resourceLoader = _ref3[2]
    ...
    function (module, exports, __webpack_require__) {
      ...
      var parseBorderRadius = exports.parseBorderRadius = function parseBorderRadius (style) {
        return SIDES.map(function (side) {
          ...
          var horizontal = _value$split$map2[0]

          var vertical = _value$split$map2[1]
    ...
    function (module, exports, __webpack_require__) {
      ...
      var lineBreakAtIndex = exports.lineBreakAtIndex = function lineBreakAtIndex (codePoints, index) {
        ...
        var _codePointsToCharacte2 = _slicedToArray(_codePointsToCharacte, 2)

        var indicies = _codePointsToCharacte2[0]

        var classTypes = _codePointsToCharacte2[1]
      ...
      var cssFormattedClasses = function cssFormattedClasses (codePoints, options) {
        ...
        var _codePointsToCharacte4 = _slicedToArray(_codePointsToCharacte3, 3)

        var indicies = _codePointsToCharacte4[0]

        var classTypes = _codePointsToCharacte4[1]

        var isLetterNumber = _codePointsToCharacte4[2]
      ...
      var inlineBreakOpportunities = exports.inlineBreakOpportunities = function inlineBreakOpportunities (str, options) {
        ...
        var _cssFormattedClasses2 = _slicedToArray(_cssFormattedClasses, 3)

        var indicies = _cssFormattedClasses2[0]

        var classTypes = _cssFormattedClasses2[1]

        var forbiddenBreakpoints = _cssFormattedClasses2[2]
      ...
      var LineBreaker = exports.LineBreaker = function LineBreaker (str, options) {
        ...
        var _cssFormattedClasses4 = _slicedToArray(_cssFormattedClasses3, 3)

        var indicies = _cssFormattedClasses4[0]

        var classTypes = _cssFormattedClasses4[1]

        var forbiddenBreakpoints = _cssFormattedClasses4[2]
      ...
      var Renderer = (function () {
        ...
        _createClass(Renderer, [{
          ...
          value: function renderStackContent (stack) {
            ...
            var _splitStackingContext2 = _slicedToArray(_splitStackingContext, 5)

            var negativeZIndex = _splitStackingContext2[0]

            var zeroOrAutoZIndexOrTransformedOrOpacity = _splitStackingContext2[1]

            var positiveZIndex = _splitStackingContext2[2]

            var nonPositionedFloats = _splitStackingContext2[3]

            var nonPositionedInlineLevel = _splitStackingContext2[4]

            var _splitDescendants = splitDescendants(stack)

            var _splitDescendants2 = _slicedToArray(_splitDescendants, 2)

            var inlineLevel = _splitDescendants2[0]

            var nonInlineLevel = _splitDescendants2[1]
    ...
    function (module, exports, __webpack_require__) {
      ...
      var parsePercentageAngle = function parsePercentageAngle (angle, bounds) {
        ...
        var _angle$split$map2 = _slicedToArray(_angle$split$map, 2)

        var left = _angle$split$map2[0]

        var top = _angle$split$map2[1]
        ...
        _createClass(DocumentCloner, [{
          ...
          value: function createElementClone (node) {
            ...
            if (node instanceof HTMLIFrameElement) {
              ...
              var width = _parseBounds.width

              var height = _parseBounds.height
    ...
    function (module, exports, __webpack_require__) {
      ...
      var parseCounterReset = exports.parseCounterReset = function parseCounterReset (style, data) {
        ...
        for (var i = 0; i < lenCounterResets; i++) {
          ...
          var _counterResets$i$spli2 = _slicedToArray(_counterResets$i$spli, 2)

          var counterName = _counterResets$i$spli2[0]

          var initialValue = _counterResets$i$spli2[1]
      ...
      var resolvePseudoContent = exports.resolvePseudoContent = function resolvePseudoContent (node, style, data) {
        ...
        if (counterIncrement && counterIncrement !== 'none') {
          ...
          var _counterIncrement$spl2 = _slicedToArray(_counterIncrement$spl, 2)

          var counterName = _counterIncrement$spl2[0]

          var incrementValue = _counterIncrement$spl2[1]
